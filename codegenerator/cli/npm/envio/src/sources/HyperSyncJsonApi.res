...
module ResponseTypes = {
  let blockDataSchema = S.object(s => {
    ...
    "difficulty": s.field("difficulty", S.option(S.null(Utils.Schema.dbBigint))),
    "totalDifficulty": s.field("total_difficulty", S.option(S.null(Utils.Schema.dbBigint))),
    "extraData": s.field("extra_data", S.option(S.string)),
    "size": s.field("size", S.option(Utils.Schema.dbBigint)),
    "gasLimit": s.field("gas_limit", S.option(Utils.Schema.dbBigint)),
    "gasUsed": s.field("gas_used", S.option(Utils.Schema.dbBigint)),
    "timestamp": s.field("timestamp", S.option(Utils.Schema.dbBigint)),
    "uncles": s.field("unclus", S.option(S.null(S.string))),
    "baseFeePerGas": s.field("base_fee_per_gas", S.option(S.null(Utils.Schema.dbBigint))),
  })
  ...
  let transactionDataSchema = S.object(s => {
    ...
    "gas": s.field("gas", S.option(Utils.Schema.dbBigint)),
    "gasPrice": s.field("gas_price", S.option(S.null(Utils.Schema.dbBigint))),
    "hash": s.field("hash", S.option(S.string)),
    ...
    "value": s.field("value", S.option(Utils.Schema.dbBigint)),
    ...
    "maxPriorityFeePerGas": s.field(
      ...
      S.option(S.null(Utils.Schema.dbBigint)),
    ),
    "maxFeePerGas": s.field("max_fee_per_gas", S.option(S.null(Utils.Schema.dbBigint))),
    "chainId": s.field("chain_id", S.option(S.null(S.int))),
    "cumulativeGasUsed": s.field("cumulative_gas_used", S.option(Utils.Schema.dbBigint)),
    "effectiveGasPrice": s.field("effective_gas_price", S.option(Utils.Schema.dbBigint)),
    "gasUsed": s.field("gas_used", S.option(Utils.Schema.dbBigint)),
